...
**Customer Discussion:**
Single user, a lot pf stocks, mutual finds, real estate, complete access to user, list pf stocks on app, customer support,

Stocks buy for long term purpose

Bonds

Sips, mutual funds regular purpose



A dashboard to see stocks, view stocks profit/loss

Separates tab for stocks, bonds, sip for holding ,graphs

Try pulling data from sample api which provides data for stocks

We can build a RAG, fixed drop down, additional complexity
